...
test('Should book a hotel room with wrong dates, update them and cancel it ', async ({ request }) => {
    ...
    const response = await booking.createBooking("Enzo", "Manuel", 912, true, "2027-10-01", "2027-10-03", "Juanfer")
    const updatedBookingData = await booking.updateBooking(response.bookingid, token, "Enzo", "Manuel", 912, true, "2018-09-12", "2018-09-22", "Juanfer")
